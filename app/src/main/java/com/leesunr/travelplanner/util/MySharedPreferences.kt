...
class MySharedPreferences(context: Context) {
    ...
    val PREFS_FILENAME5 = "main_group"
    ...
    val prefs_main_group: SharedPreferences = context.getSharedPreferences(PREFS_FILENAME5, 0)
    ...
    var mainGroup: String?
        get() = prefs_main_group.getString(PREF_KEY_MY_EDITTEXT, null)
        set(value) = prefs_main_group.edit().putString(PREF_KEY_MY_EDITTEXT, value).apply()
